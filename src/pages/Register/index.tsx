            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                >
                  ...
                  <span
                    className={`font-medium ${
                      role === "user" ? "text-blue-600" : "text-gray-700"
                    }`}
                  >
                    User
                  </span>
                ...
                >
                  ...
                  <span
                    className={`font-medium ${
                      role === "organizer" ? "text-blue-600" : "text-gray-700"
                    }`}
                  >
                    Organizer
                  </span>
            ...
            <div>
              ...
              <div className="relative mt-1">
                <input
                  ...
                  className="w-full pl-4 pr-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-4 focus:ring-blue-100 focus:border-blue-500 outline-none transition-all"
                />
              </div>
            </div>
